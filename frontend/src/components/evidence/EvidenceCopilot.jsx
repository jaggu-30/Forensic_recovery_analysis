...
function buildAnswer(question, evidence, recoverySummary) {
  ...
  if (
    ...
    return {
      ...
      text: `${evidence.name} currently has a recovery confidence of ${evidence.confidence}%. The evidence is classified as "${evidence.status}". The available demonstration data records ${evidence.fragments} fragments for this evidence item, with an integrity value of ${evidence.integrity}.`,
      points: [
  ...
  if (
    ...
    return {
      ...
      text: `${evidence.name} is currently associated with ${evidence.fragments} detected fragments in the demonstration dataset. Fragment relationships should be evaluated using structural characteristics, offsets, file signatures, and compatibility rather than treating semantic similarity alone as proof.`,
      points: [
  ...
  if (
    ...
    return {
      ...
      text: `${evidence.name} has an integrity value of ${evidence.integrity}. The integrity value describes the structural validation represented by the current demonstration dataset. It should not be interpreted as proof that every byte is identical to the original evidence.`,
      points: [
  ...
  return {
    ...
    text: `I can analyze the currently selected evidence item, ${evidence.name}, using the available recovery metadata. I do not have sufficient evidence in the current demonstration dataset to make a more specific forensic conclusion about that question.`,
    points: [
  ...
  return (
    <aside className="evidence-copilot">
      ...
      <div className="copilot-input-area">
        ...
        <small>
          AI responses are grounded in available evidence.
          Unsupported conclusions are marked as insufficient
          evidence.
        </small>
      </div>
    </aside>
